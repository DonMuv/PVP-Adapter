...
class CDTrainer():
    ...
    def _load_checkpoint(self, ckpt_name='last_ckpt.pt'):
        print("\n")
        checkpoint = torch.load('ckpt_dir/20250318-ablation-att_ada3-gelu-005-NotMRDA/iou9220.pt',
    ...
    def _update_checkpoints(self):
        ...
        if self.epoch_acc > self.best_val_acc:
            ...
            self._save_checkpoint(ckpt_name='best_ckpt_e' + str(self.epoch_id) + '.pt')
    ...
    def _forward_pass(self, batch):
        ...
        self.G_pred = self.net_G(img_in1, img_in2, batch['name'])
