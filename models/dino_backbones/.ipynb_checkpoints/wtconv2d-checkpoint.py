...
from .wavelet import create_wavelet_filter, wavelet_transform
...
class WTConv2d(nn.Module):
    ...
    def forward(self, x):
        ...
        for i in range(self.wt_levels):
            ...
            x_ll_in_levels.append(curr_x_tag[:,:,0,:,:])    # [1, 1024, 16, 16]
            x_h_in_levels.append(curr_x_tag[:,:,1:4,:,:])   # [1, 1024, 3, 16, 16]
