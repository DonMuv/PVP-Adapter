...
class CrossAttentionHfcPatch(nn.Module):
    ...
    def forward(
        ...
        # hfc_embed = self.proj_hfc(hfc_embed.permute(1, 2, 0))
        # patch_embed = self.proj_patch(patch_embed.permute(1, 2, 0))

        # print(hfc_embed.shape, patch_embed.shape)
