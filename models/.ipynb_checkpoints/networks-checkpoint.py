...
from models.ChangeModels import ChangeAdapter
...
def define_G(args, init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    elif args.net_G == 'ChangeAdapter':
        net = ChangeAdapter(embed_dim=args.embed_dim) #ChangeFormer with Transformer Encoder and Convolutional Decoder (Fuse)

    elif args.net_G == 'ChangeMAE':
        net = ChangeMAE(embed_dim=args.embed_dim)
